...
static const char *fonts[]          = { "siji:size=15" };
//static const char *fonts[]          = { "-wuncon-siji-medium-r-normal-*-10-100-75-75-c-80-iso10646-1:size=15" };
...
static const char tokyofg[]         = "#a9b1d6";
static const char tokyobg[]         = "#24283b";
static const char tokyobd[]         = "#7aa2f7";
static const char *colors[][3]      = {
	/* fg         bg         border   */
  { tokyofg, tokyobg, tokyobd       }, /* Tokyo-Night */
  { s_base00, s_base02, s_base2     }, /* SchemeNorm dark */
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", s_base0, "-sf", s_base03, NULL };
